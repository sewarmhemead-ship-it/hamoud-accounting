...
export const transactionsApi = {
  ...
  createExpense: (data) => client.post('/transactions/expense', data),
...
export const adminApi = {
  ...
  listSources:    ()        => client.get('/admin/sources'),
  createSource:   (data)    => client.post('/admin/sources', data),
  updateSource:   (id, d)   => client.put(`/admin/sources/${id}`, d),
  listDestinations:()       => client.get('/admin/destinations'),
  createDestination:(data)  => client.post('/admin/destinations', data),
  updateDestination:(id, d) => client.put(`/admin/destinations/${id}`, d),
